...
import * as Permisiions from "expo-permissions";
...
export default function InfoUser(props) {
    ...
    const changeAvatar= async()=>{
        var result;
        const resultPermission = await Permisiions.askAsync(Permisiions.CAMERA_ROLL);
        ...
        if(result.cancelled){
            toastRef.current.show("Ha cerrado la selección de imagen")
        }else{
