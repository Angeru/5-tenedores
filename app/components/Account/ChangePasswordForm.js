...
export default function ChangePasswordForm(props){
    ...
    const onSubmit = async ()=>{
        ...
        }else if(formData.newPassword !== formData.repeatNewPassword)
        {
            ...
            errorsTemp = {
                newPassword: "La contraseña ha de ser mayor de 5 caracteres",
                repeatNewPassword: "La contraseña ha de ser mayor de 5 caracteres"
            }
        }else{
            setIsLoading(true)
            await reauthenticate(formData.password).then(async ()=>{
                ...
                .currentUser.updatePassword(formData.newPassword).then(()=>{
                    ...
                    errorsTemp={
                        other: "Error al acutalizar la contraseña"
                    }
                    setIsLoading(false)
                })
